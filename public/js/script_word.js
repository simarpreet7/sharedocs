...
function god(){
socket.emit('boom',{change:document.getElementById("editor1").innerText});
}
socket.on('btoc',(data)=>{
 
  document.getElementById("editor1").innerText=data.change

  elem = document.getElementById('editor1');//This is the element that you want to move the caret to the end of
